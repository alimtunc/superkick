...
import { ChatContextRailToggle } from '@/domains/chat/components/ChatContextRailToggle'
import { ChatConversationView } from '@/domains/chat/components/ChatConversationView'
import { ChatSidebar } from '@/domains/chat/components/ChatSidebar'
import { EmptyChat } from '@/domains/chat/components/EmptyChat'
import { NewChatLauncher } from '@/domains/chat/components/NewChatLauncher'
import { IssueContextPanel } from '@/domains/issues/components/IssueContextPanel'
...
export function ChatPanel({ subject }: ChatPanelProps) {
	...
	return (
		<section className="flex h-full min-h-0 flex-1 overflow-hidden rounded-md border border-border bg-surface/40">
			<ChatSidebar
				conversations={list.conversations}

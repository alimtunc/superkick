import { SECTION_LIMIT, isDone } from '@/domains/command/components/commandSections'
import { buildEmptyRows } from '@/domains/command/components/sections/buildEmptyRows'

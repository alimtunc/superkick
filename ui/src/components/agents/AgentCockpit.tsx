...
import { agentExecutor, isDeletableAgent, policyServers, skillLabel, toolList } from '@/lib/agents'
...
export function AgentCockpit({ name }: AgentCockpitProps) {
	...
	const deletable = isDeletableAgent(agent)
		...
		<div className="flex flex-col gap-5">
			...
			<section className="rounded-[8px] border border-(--border-faint) p-4">
				<div className="grid grid-cols-2 gap-4 md:grid-cols-3">
					...
					<DetailField label="Linear context" value={LINEAR_CONTEXT_LABEL[agent.linear_context]} />
				</div>
			</section>

...
export function SideDrawer({
	...
	return (
		...
		>
			<Dialog.Portal>
				<Dialog.Backdrop className="fixed inset-0 z-overlay bg-surface/60 backdrop-blur-sm transition-opacity duration-200 data-[ending-style]:opacity-0 data-[starting-style]:opacity-0" />
				<Dialog.Popup
					className={cn(
						'fixed top-0 right-0 z-drawer flex h-dvh flex-col border-l border-border bg-surface shadow-2xl transition-transform duration-200 outline-none data-ending-style:translate-x-full data-starting-style:translate-x-full',
						WIDTH_CLASS[width]
					)}
				>
